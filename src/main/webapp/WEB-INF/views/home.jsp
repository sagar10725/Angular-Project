...
<body>
 ...
 -->
	...
	<div>
		...
		<div class="right">
			<ins style="width: 300px; height: 45px; padding: 0px; margin:5px -9px;"
				class="nepalipatro-wg" widget="daysmall"></ins>
	...
	<script src="resources/js/controller/SalaryCalcCtrl.js"></script>
